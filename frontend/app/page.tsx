  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16">
      ...
      <p className="mt-2 text-neutral-600">
        ...
        <code className="rounded bg-neutral-100 px-1">lib/api.ts</code>). Sua missão é construir a
        interface do inbox de atendimento WhatsApp. Veja o{" "}
      ...
      <ol className="mt-8 list-decimal space-y-1 pl-5 text-sm text-neutral-700">
        ...
        <li>
          Botão &quot;Sugerir resposta com IA&quot; (chama <code>/ai/suggest</code>).
        </li>
